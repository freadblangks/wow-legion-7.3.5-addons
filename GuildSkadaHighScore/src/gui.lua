...
function gui:CreateHighScoreTabGroup()
	...
	container:SetTabs({
		{value = "DAMAGER", text = "傷害輸出"},
		{value = "HEALER", text = "治療者"},
		{value = "TANK", text = "坦克"}
	});
...
function gui:CreateMainFrame()
	...
	frame:SetWidth(800);
	frame:SetHeight(600);
	frame:SetTitle(format("Skada 戰鬥統計 公會排名 (%s)", addon.versionName));
	...
	dropdownContainer:SetTitle("選擇一場戰鬥");

...
L.AlertUpgradesTip = '如停用，戰鬥中野生寵物戰鬥升級提醒框將不再顯示，但升級將以一個標記顯示。位置：（|TInterface\\GossipFrame\\AvailableQuestIcon:0:0:-1:-2|t）。'
...
L.FAQ = {
	...
	'如何停用全部野生寵物出現提示？',
	'到主界面選單，打開插件列表並停用 PetTracker 野生寵物出現。',
